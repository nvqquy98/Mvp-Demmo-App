...
class PhotoAdapter : RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun bind(photo: Photo) {
            ...
            if (!photo.photoUrl.isBlank())
                loadImage(photo.photoUrl, R.id.imageViewPicture)
            if (!photo.photoUserUrl.isBlank())
        ...
        private fun loadImage(imageUrl: String, id: Int) {
            when (id) {
                R.id.imageViewPicture -> LoadImageFromUrl(itemView.imageViewPicture).executeOnExecutor(
